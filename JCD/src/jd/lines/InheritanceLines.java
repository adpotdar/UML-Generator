...
// CONNECTOR TO SHOW THE INHERITANCE RELATIONSHIP
public class InheritanceLines extends Line{
    ...
    public InheritanceLines(Diagram childDiagram, Diagram parentDiagram,VBox child,VBox parent,Pane pane){
    ...
    public void lineSplit(InheritanceLines line,VBox child, VBox parent,Pane pane){
